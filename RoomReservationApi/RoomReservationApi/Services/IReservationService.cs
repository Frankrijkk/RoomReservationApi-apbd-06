...
public interface IReservationService
{
    ...
    public void UpdateReservation(long id,long? roomId,string? organizerName,string? topic,DateOnly? date,TimeOnly? startTime,TimeOnly? endTime,ReservationStatus? status);
